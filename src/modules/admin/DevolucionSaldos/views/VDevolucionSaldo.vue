...
const detalleDevolucion = ref<IDevolucionSaldo>()
...
const openNew = () => {
  devolucionSaldo.value = {} as IDevolucionSaldo
...
const verDetalleTransaccion = async (detTrnDevolucion: IDevolucionSaldo) => {
...
<template>
      ...
      <div class="card">
        ...
        >
          <template #header>
            ...
            >
              <h4 class="m-0">Devolucion de Saldos</h4>
          ...
          >
          <Column field="fecha_devolucion" header="Fecha devolución" sortable>
            <template #body="slotProps">
              <span class="p-column-title">Fecha devolución</span>
              {{ slotProps.data.fecha_devolucion }}
            </template></Column
          >
    ...
    <div class="p-grid p-dir-col">
      ...
      <div class="field p-mb-3">
        <label class="p-text-bold" for="fecha"
          >Fecha devolución<i class="pi pi-calendar p-mr-2"></i
        ></label>
        <div class="field-value">
          {{ detalleDevolucion?.fecha_devolucion }}
        </div>
      </div>
  ...
  >
    <div class="field">
      ...
      <Dropdown
        id="billetera_id"
        v-model="devolucionSaldo.billetera_id"
        :options="billeteraUsuarios"
        optionLabel="usuarioBilletera"
        optionValue="id"
        filter
        filterPlaceholder="Buscar abogado"
        :invalid="submitted && !devolucionSaldo.billetera_id"
        @change="onSelectBilletera"
      />
      <small class="p-error" v-if="submitted && !devolucionSaldo.billetera_id"
        >Debe seleccionar la billetera a devolver.</small
      >
    </div>
