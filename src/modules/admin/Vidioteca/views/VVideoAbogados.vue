...
const loadVideos = async (event?: DataTableSortEvent) => {
  ...
  const response = await videoService.getVideosAbogados(opciones)
      ...
      <div class="card">
        ...
        >
          <template #header>
            ...
            >
              <h4 class="m-0">Administrar Videos Para Abogados</h4>
