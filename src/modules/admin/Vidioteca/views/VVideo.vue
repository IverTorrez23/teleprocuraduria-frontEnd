...
const loadVideos = async (event?: DataTableSortEvent) => {
  ...
  const response = await videoService.getVideos(opciones)
      ...
      <div class="card">
        ...
        >
          <template #header>
            ...
            >
              <h4 class="m-0">Administrar Videos Publicos</h4>
          ...
          <Column field="titulo" header="Título" sortable style="width: 20%;">
