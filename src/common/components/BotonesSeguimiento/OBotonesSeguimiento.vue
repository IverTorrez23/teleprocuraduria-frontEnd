  ...
  <div class="card custom-div flex flex-row align-items-stretch mb-1">
    <div v-if="isHorizontalVisible" class="div-horizontal">
      <Button
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenGiradas')"
      />
      <Button
        type="button"
        label="P1$2"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenPrePresupuestada')"
      />
      <Button
        type="button"
        label="P2"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenPresupuestadas')"
      />
      <Button
        type="button"
        label="P3"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenInfoDocEntregado')"
      />
      <Button
        type="button"
        label="P4"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenDineroEntregado')"
      />
      <Button
        type="button"
        label="P5"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenListaRealizar')"
      />
      <Button
        type="button"
        label="P6"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenDescargadas')"
      />
      <Button
        type="button"
        label="P7"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenPronuncioAbogado')"
      />
      <Button
        type="button"
        label="P8"
        ...
        rounded
        class="mr-2 mb-2"
        @click="goToRoute('CausasOrdenCuentasConciliadas')"
      />
    </div>
    <!-- Botones verticales -->
